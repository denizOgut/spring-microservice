...
public class BookingService {
    ...
    @RateLimiter(name = "bookingCode", fallbackMethod = "getDefaultBookingApiResponseDtoFallbackMethod")
    ...
    private BookingApiResponseDto getDefaultBookingApiResponseDtoFallbackMethod() {
        logger.error("Booking not found for given booking code");
        return new BookingApiResponseDto(null, null);
    }
